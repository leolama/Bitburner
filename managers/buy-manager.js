        ...
        for (let i = 0; i < programs.length; ++i) {
            ...
            if (ns.getPlayer().tor === true) {
                if (!ns.fileExists(programs[0])) {
                    if (await getNsDataThroughFile(ns, `ns.singularity.purchaseProgram('${programs[0]}')`)) {
            ...
            else if (!await getNsDataThroughFile(ns, 'ns.singularity.purchaseTor()', '/data/TEMP-purchasetor.txt')) {
